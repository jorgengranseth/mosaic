...
class LASToGeometryDataSource(DataSource):
    ...
    def schema(self) -> StructType:
        ...
        return StructType([
            ...
            StructField("scan_direction_flag", IntegerType(), True),
            StructField("edge_of_flight_line", IntegerType(), True),
            StructField("classification", IntegerType(), True),
            StructField("synthetic", IntegerType(), True),
            StructField("key_point", IntegerType(), True),
            StructField("withheld", IntegerType(), True),
            StructField("scan_angle", IntegerType(), True),
